...
@click.option('-t', '--resource_type',
              type=click.Choice(['all', 'users', 'projects_importers', 'knowledge_models']), default='all',
              help='Specify the type of resource to list (all, users, projects_importers, knowledge_models)')
